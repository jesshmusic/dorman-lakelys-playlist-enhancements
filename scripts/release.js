...
moduleJson.download = `https://github.com/jesshmusic/dorman-lakelys-playlist-enhancements/releases/download/v${newVersion}/module.zip`;
...
console.log('3. Push to trigger release workflow');
